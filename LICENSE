...
These license terms are an agreement between you and Microsoft Corporation (or one of its affiliates). They apply to the source code, object code, and/or data for the “Human Dialogue Data Collection” (collectively “The Materials”) that accompany this license. IF YOU COMPLY WITH THESE LICENSE TERMS, YOU HAVE THE RIGHTS BELOW. BY USING THE MATERIALS, YOU ACCEPT THESE TERMS.
...
d) General. You may install and use any number of copies of the software.
2) SCOPE OF LICENSE. The Materials are licensed free of charge without extending any intellectual property rights, not sold. Microsoft reserves all other rights. Unless applicable law gives you more rights despite this limitation, you will not (and have no right to):
...
6) PERSONAL DATA. Personal data is any information relating to an identified or identifiable natural person. Microsoft will undertake to ensure that the Materials contain no personal data. If, despite Microsoft’s efforts in this regard, you identify personal data in the Materials, you agree not to use such personal data for any purpose, to delete all copies of such personal data in your possession promptly, and to inform Microsoft promptly of the foregoing so that it can remove such personal data from future transmissions of the Materials.
