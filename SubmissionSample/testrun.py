...
Commands:
Rule: python run.py --agt 5 --usr 1 --max_turn 40 --episodes 150 --kb_path .\deep_dialog\data_movie\movie_kb.1k.p --goal_file_path .\deep_dialog\data_movie\user_goals_first_turn_template.part.movie.v1.p --intent_err_prob 0.00 --slot_err_prob 0.00 --episodes 500 --act_level 1 --run_mode 1
...
pathx=pathx.replace("testrun.py","")

sys.path.append(pathx+"run.zip")
